...
namespace PixelCrew
{
    public class RandomSpawner : MonoBehaviour
    {
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Handles.DrawWireArc(position, Vector3.forward, rightBound, _sectorAngle, 2f);//not completed radius

            Handles.color = new Color(1f, 1f, 1f, 0.1f);
            Handles.DrawSolidArc(position, Vector3.forward, rightBound, _sectorAngle, 2f);//not completed radius
        }
